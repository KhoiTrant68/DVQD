...
def get_parser(**parser_kwargs):
    ...
    # Add more arguments if necessary
    parser.add_argument(
        "-b",
        "--base",
        nargs="*",
...
def training_function(config: Dict, args: argparse.Namespace):
    ...
    # Initialize Weights and Biases tracking if enabled
    ...
    if scheduler_type == "linear-warmup":
        scheduler_ae = LambdaLR(optimizer_ae, warmup_steps, training_steps)
        scheduler_disc = LambdaLR(optimizer_disc, warmup_steps, training_steps)
