...
accelerate launch --multi_gpu train.py --base src/configs/stage1/triple_dynamic_entropy_imagenet.yml --max_epochs 30 --mode entropy --with_tracking --resume_from_checkpoint /home/infordio-ai/khoi/HU/DVQD/output/best_checkpoint.ckpt
