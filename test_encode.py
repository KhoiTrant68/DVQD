...
# from src.stage1.modules.dynamic_modules.encoder_tripple import \
#     TripleGrainEncoder
...
#             resolution=256,
#             z_channels=256,
#             router_config=dual_entropy_router_config,
#         )

#     def test_forward(self):
#         x = torch.randn(4, 3, 256, 256)
#         x_entropy = torch.randn(4, 3, 256, 256)
#         output = self.encoder(x, x_entropy)
#         print(output["h_dual"].shape)
#         print(output["indices"].shape)
#         print(output["codebook_mask"].shape)


# class TestTripleGrainEncoder(unittest.TestCase):
#     def setUp(self):
#         self.encoder = TripleGrainEncoder(
#             ch=128,
#             ch_mult=[1, 1, 2, 2, 4, 4],
#             num_res_blocks=2,
...
#             resolution=256,
#             z_channels=256,
#             router_config=triple_entropy_router_config,
#         )
...
#         self.assertIn("h_triple", output)
#         self.assertIn("indices", output)
#         self.assertIn("codebook_mask", output)
